      ...
      <Card className="border-cyan-500/20 bg-slate-950/60 backdrop-blur-sm">
        <CardHeader className="flex flex-row items-center gap-4">
          ...
          <div>
            ...
            <p className="text-cyan-400 text-sm tracking-wider">{profile.rollNo}</p>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <p className="text-xs text-slate-500 uppercase tracking-wider">Roll Number</p>
              <p className="text-slate-300">{profile.rollNo || 'Not assigned'}</p>
            </div>
            <div>
